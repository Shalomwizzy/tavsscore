...
@section('content')
<style>
    .sm-head{position:relative;overflow:hidden;padding:1.4rem;border:1px solid rgba(103,232,249,.22);border-radius:17px;background:radial-gradient(circle at 95% 5%,rgba(103,232,249,.19),transparent 25%),linear-gradient(135deg,#10243e,#09141e);margin-bottom:1rem}.sm-head:after{content:"";position:absolute;right:-45px;bottom:-105px;width:230px;height:230px;border-radius:50%;border:1px solid rgba(103,232,249,.2)}.sm-head>*{position:relative;z-index:1}.sm-eye{color:#67e8f9;font-size:.64rem;font-weight:900;letter-spacing:.12em;text-transform:uppercase}.sm-title{margin:.4rem 0;color:#fff;font-size:1.55rem;font-weight:900}.sm-sub{max-width:700px;margin:0;color:var(--dim);font-size:.78rem;line-height:1.55}.sm-actions{display:flex;gap:.55rem;flex-wrap:wrap;margin-top:1rem}.sm-rebuild{background:#67e8f9!important;color:#082033!important;border-color:#67e8f9!important}.sm-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:.75rem;margin:1rem 0}.sm-stat{padding:.9rem;border:1px solid var(--border);border-radius:12px;background:var(--card)}.sm-stat span{display:block;color:var(--dim);font-size:.65rem;text-transform:uppercase;letter-spacing:.08em;font-weight:900}.sm-stat strong{display:block;margin-top:.3rem;color:#fff;font-size:1.35rem}.sm-card-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem}.sm-card{position:relative;overflow:hidden;padding:1rem;border:1px solid rgba(148,163,184,.22);border-radius:15px;background:linear-gradient(145deg,#111d30,#0b1422)}.sm-card:before{content:"";position:absolute;inset:0 0 auto;height:3px;background:linear-gradient(90deg,#67e8f9,#38bdf8)}.sm-rank{font-size:.64rem;letter-spacing:.1em;font-weight:900;color:#67e8f9}.sm-match{margin:.45rem 0 .22rem;color:#fff;font-weight:900;font-size:1.05rem}.sm-meta{color:var(--dim);font-size:.68rem}.sm-market{margin:.8rem 0;padding:.7rem;border-radius:10px;background:rgba(103,232,249,.07);border:1px solid rgba(103,232,249,.14);color:#cffafe;font-size:.78rem;font-weight:850}.sm-market b{float:right;font-size:.95rem}.sm-start{display:inline-block;margin-top:.45rem;margin-right:.25rem;padding:.25rem .4rem;border-radius:6px;background:rgba(255,255,255,.08);color:#fff;font-size:.65rem}.sm-label{margin-top:.8rem;color:var(--dim);font-size:.61rem;letter-spacing:.08em;text-transform:uppercase;font-weight:900}.sm-reasons{display:grid;gap:.35rem;margin-top:.4rem}.sm-reason{border-left:2px solid #67e8f9;background:rgba(255,255,255,.025);padding:.45rem .55rem;color:#cbd5e1;font-size:.69rem;line-height:1.45}.sm-intel{margin-top:.7rem}.sm-intel details{background:rgba(0,0,0,.12)!important;border-color:rgba(148,163,184,.17)!important}.sm-empty{border:1px dashed rgba(103,232,249,.28);border-radius:14px;padding:1.4rem;background:rgba(103,232,249,.035);color:var(--dim);font-size:.78rem;line-height:1.55}.sm-empty strong{display:block;margin-bottom:.35rem;color:#fff;font-size:.9rem}.sm-history{margin-top:1rem;border:1px solid var(--border);border-radius:13px;background:var(--card);overflow:hidden}.sm-history h2{margin:0;padding:1rem;color:#fff;font-size:.9rem;border-bottom:1px solid var(--border)}.sm-history-row{display:flex;justify-content:space-between;gap:.8rem;padding:.75rem 1rem;border-bottom:1px solid rgba(255,255,255,.06);font-size:.72rem;color:var(--dim)}.sm-history-row strong{color:#dbeafe}.sm-history-row:last-child{border-bottom:0}@media(max-width:760px){.sm-grid,.sm-card-grid{grid-template-columns:1fr}.sm-head{padding:1.1rem}.sm-actions form,.sm-actions .btn-a{width:100%}.sm-actions .btn-a{justify-content:center}.sm-history-row{align-items:flex-start;flex-direction:column;gap:.25rem}}
</style>

<section class="sm-head">
    <div class="sm-eye">Specialty market control room</div>
    <h1 class="sm-title">{{ $config['icon'] }} {{ $config['title'] }}</h1>
    <p class="sm-sub">Only exact-market signals at <strong style="color:#cffafe">90% confidence or higher</strong> can be published. Pulling the latest data refreshes fixtures, rebuilds the model board, selects qualified picks, and sends only valid signals to Telegram and OneSignal.</p>
...
<section class="sm-card-grid" aria-label="Today's {{ $config['title'] }} picks">
    @foreach($todayCards as $card)
        ...
        <article class="sm-card">
            ...
            <div class="sm-intel">
                @include('partials.match-intelligence', ['insight' => $card['insight'], 'prediction' => $pick, 'accent' => '#67e8f9'])
            </div>
        </article>
    @endforeach
</section>
