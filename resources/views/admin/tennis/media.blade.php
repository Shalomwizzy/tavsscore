...
<div style="max-width:900px;">
    <div style="margin-bottom:1.25rem;padding:1.35rem;border-radius:14px;border:1px solid rgba(103,232,249,.28);background:radial-gradient(circle at 90% 0%,rgba(56,189,248,.16),transparent 30%),linear-gradient(135deg,#112a46,#08121f);">
        <div style="font-size:.66rem;font-weight:900;letter-spacing:.1em;text-transform:uppercase;color:#67e8f9;">TavsScore Tennis</div>
    ...
    <form method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data">
        ...
        <section style="background:var(--card);border:1px solid var(--border);border-radius:14px;overflow:hidden;">
            <div style="aspect-ratio:21/9;background:linear-gradient(135deg,#173b61,#0b1422);display:grid;place-items:center;border-bottom:1px solid var(--border);">
