...
class ResultsFallbackTest extends TestCase
{
    ...
    public function test_espn_settles_verified_legacy_club_names(): void
    {
        Config::set('services.football_data.key', null);
        Config::set('services.espn.leagues', ['all']);

        $match = $this->pendingMatch('FK Crvena Zvezda', 'Larne');
        Prediction::create([
            'match_id' => $match->id, 'home_win_prob' => 80.0, 'draw_prob' => 10.0, 'away_win_prob' => 10.0,
        ...
        Http::fake([
            'site.api.espn.com/*' => Http::response(['events' => [[
                ...
                'competitions' => [[
                    ...
                    'competitors' => [
                        ['homeAway' => 'home', 'score' => '5', 'team' => ['id' => '1', 'displayName' => 'Red Star Belgrade']],
                        ['homeAway' => 'away', 'score' => '0', 'team' => ['id' => '2', 'displayName' => 'Larne']],
                    ],
                ]],
            ]]], 200),
        ]);
        ...
        $this->assertSame(1, $result['predicted_updated']);
        $this->assertSame(5, (int) $match->fresh()->home_score);
    ...
    public function test_espn_penalty_score_uses_regulation_time_not_shootout_total(): void
    {
        Config::set('services.football_data.key', null);
        Config::set('services.espn.leagues', ['all']);
        $match = $this->pendingMatch('Lech Poznan', 'Aarhus');
        ...
        Http::fake([
            'site.api.espn.com/*' => Http::response(['events' => [[
                ...
                'competitions' => [[
                    ...
                    'competitors' => [
                        ['homeAway' => 'home', 'score' => '1', 'team' => ['id' => '1', 'displayName' => 'Lech Poznan']],
                        ['homeAway' => 'away', 'score' => '4', 'team' => ['id' => '2', 'displayName' => 'AGF']],
                    ],
                    'details' => [
                        ['scoringPlay' => true, 'team' => ['id' => '2'], 'clock' => ['displayValue' => "32'"]],
                        ['scoringPlay' => true, 'team' => ['id' => '2'], 'clock' => ['displayValue' => "55'"]],
                        ['scoringPlay' => true, 'team' => ['id' => '2'], 'clock' => ['displayValue' => "75'"]],
                        ['scoringPlay' => true, 'team' => ['id' => '1'], 'clock' => ['displayValue' => "95'"]],
                        ['scoringPlay' => true, 'shootout' => true, 'team' => ['id' => '2'], 'clock' => ['displayValue' => "120'"]],
                    ],
                ]],
            ]]], 200),
        ]);
        ...
        $this->assertSame(1, $result['updated']);
        $this->assertSame(0, (int) $match->fresh()->home_score);
        $this->assertSame(3, (int) $match->fresh()->away_score);
    }
